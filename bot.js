...
var emojis   = { arrow: `${client.guilds.find(r => r.id === '558136332258639884').emojis.find(e => e.name === 'arrow')}` };
       ...
       ${emojis.arrow},  | ${prefix}mhelp ⇏ اوامر الموسيقي
...
var emojis   = { arrow: `${client.guilds.find(r => r.id === '558136332258639884').emojis.find(e => e.name === 'arrow')}` };
       ...
       message.channel.send(`** • قـــائمة اوامر الموسيقي ** :
        ${emojis.arrow},  | ${prefix}play ⇏ لتشغيل اغنية
       ${emojis.arrow},  | ${prefix}skip ⇏ لتجاوز الاغنية الحالية
       ${emojis.arrow},  | ${prefix}stop ⇏ اخراج البوت من رومك
       ${emojis.arrow},  | ${prefix}song ⇏ لمعرفة اسم ولينك الاغنية
       ${emojis.arrow},  | ${prefix}vol ⇏ اخراج البوت من رومك
       ${emojis.arrow},  | ${prefix}que ⇏ لعرض قائمة الاغانى
       ${emojis.arrow},  | ${prefix}pause ⇏ لايقاف الاغنية مؤقتا
       ${emojis.arrow},  | ${prefix}resume ⇏ لتشغيل الاغنية من جديد
        ${emojis.arrow},  | ${prefix}mute ⇏ لاعطاء البوت ميوت 
        ${emojis.arrow},  | ${prefix}unmute ⇏ لفك الميوت عن البوت 
      ${emojis.arrow},  | cooming soon ⇏ قريبا سيتم تحديث اوامر الموسيقي واضافة اوامر اخرى
...
client.on('ready', () => {
  ...
  client.user.setActivity(`$help | $invite | Version: 1.0.0`)
...
client.channels.get("558124153924878368").sendEmbed(embed)
});
...
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("558124187638562836").sendEmbed(embed)
});
...
client.on('message', message => {
    if(message.content == prefix + 'servers') {
             if(!message.author.id === '510970297814614016') return;
    var gimg;
    var gname;
    var gmemb;
    var gbots;
...
:checkered_flag: تاريخ انضمامك للسيرفر ${member.joinedAt.toLocaleString()} :checkered_flag:`) 
  ...
  client.on('message',async message => {
    if(message.content.startsWith(prefix + "restart")) {
        if(message.author.id !== "510970297814614016") return message.reply('You aren\'t the bot owner.');
...
client.on('message', message => {
                if(message.content === prefix + "invite") {
                  ...
                  .setFooter(`NASA Bot `,'https://cdn.pg.sa/Rj3wwoEoTZ.png')
...
client.on('message', message => {
            if(!message.channel.guild) return;
let args = message.content.split(' ').slice(1).join(' ');
if (message.content.startsWith('$cbgaber')){
 if(!message.author.id === '510970297814614016') return;
...
client.login("NzExNzQwNTQ4MTg4NDcxMzM5.XsHaCg.tnCs9FnXMO_c-Ch26Ah_HRIjj-s");
